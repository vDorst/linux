...
#define DOVE_PCIE0_LINK_CTRL	(DOVE_PCIE0_VIRT_BASE | 0x0070)
#define DOVE_PCIE0_STATUS	(DOVE_PCIE0_VIRT_BASE | 0x1a04)
#define DOVE_PCIE1_VIRT_BASE	(DOVE_SB_REGS_VIRT_BASE | 0x80000)
#define DOVE_PCIE1_LINK_CTRL	(DOVE_PCIE1_VIRT_BASE | 0x0070)
#define DOVE_PCIE1_STATUS	(DOVE_PCIE1_VIRT_BASE | 0x1a04)
...
#define SATA_VIRT_BASE		(DOVE_SB_REGS_VIRT_BASE | 0x80000)
